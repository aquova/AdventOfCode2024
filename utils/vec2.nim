...
const FOURWAY = [NORTH, EAST, SOUTH, WEST]

const CROSSWAY = [NORTHEAST, SOUTHEAST, SOUTHWEST, NORTHWEST]

const EIGHTWAY = [NORTH, NORTHEAST, EAST, SOUTHEAST, SOUTH, SOUTHWEST, WEST, NORTHWEST]
